...
output "dev_lambda_collector_role_arn" {
  description = "Lambda Collector IAM role ARN managed by Dev environment."
...
output "dev_eks_cluster_role_arn" {
  description = "EKS Cluster IAM role ARN managed by Dev environment."
