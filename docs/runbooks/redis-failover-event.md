# Redis Event / Failover

## Summary

ElastiCache Redis event notification detected.
...
Check replication group status, primary endpoint, failover timeline, cache miss spike, and application errors.
